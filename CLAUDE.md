...
5. Booking tracking — `LS_BOOKINGS = "nzTrip_bookings_v1"`, keyed by `"booking-"+index`; drives the dynamic unbooked-items summary (`#unbooked-list`, `#booking-summary-count`).
